  ...
  return (
    <div style={{maxWidth:960,margin:'0 auto',padding:24}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16,marginBottom:28}}>
        {[
          {label:'Monthly Target', value:'KES ' + Number(group.monthly_target).toLocaleString()},
          {label:'Total Collected', value:'KES ' + Number(summary.total_collected || 0).toLocaleString()},
